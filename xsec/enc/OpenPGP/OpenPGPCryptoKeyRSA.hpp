 ...
 *
 * $Id: OpenPGPCryptoKeyRSA.hpp 1350045 2012-06-13 22:33:10Z scantor $
 *
 */

#ifndef OPENPGPCRYPTOKEYRSA_INCLUDE
#define OPENPGPCRYPTOKEYRSA_INCLUDE
...
class DSIG_EXPORT OpenPGPCryptoKeyRSA : public XSECCryptoKeyRSA {
...
public :
	...
	/**
	 * \brief Return the OpenPGP identifier string
	 */
	...
	/** @name OpenPGP specific methods */
	//@{

	/**
	 * \brief Constructor to create the object around an existing OpenPGP RSA
	 * key
	 *
	 */

	OpenPGPCryptoKeyRSA(const std::vector<PGPMPI> &pub, const std::vector<PGPMPI> &pri=std::vector<PGPMPI>());

	/**
	 * \brief Get OpenPGP RSA Private Object
	 */

	std::vector<PGPMPI> getOpenPGPRSAPrivate(void) {return mp_rsaKey;}

    /**
	 * \brief Get OpenPGP RSA Private Object
	 */

	const std::vector<PGPMPI> getOpenPGPRSAPrivate(void) const {return mp_rsaKey;}

	/**
	 * \brief Get OpenPGP RSA Object
	 */

	std::vector<PGPMPI> getOpenPGPRSA(void) {return mp_rsaPub;}

    /**
	 * \brief Get OpenPGP RSA Object
	 */

	const std::vector<PGPMPI> getOpenPGPRSA(void) const {return mp_rsaPub;}

	//@}

private:

	std::vector<PGPMPI>				m_rsaKey;
	std::vector<PGPMPI>				m_rsaPub;

};

#endif /* XSEC_HAVE_OPENPGP */
#endif /* OPENPGPCRYPTOKEYRSA_INCLUDE */
