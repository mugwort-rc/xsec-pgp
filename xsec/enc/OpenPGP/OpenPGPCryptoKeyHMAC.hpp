 ...
 *
 * $Id: OpenPGPCryptoKeyHMAC.hpp 1125514 2011-05-20 19:08:33Z scantor $
 *
 */

#ifndef OPENPGPCRYPTOKEYHMAC_INCLUDE
#define OPENPGPCRYPTOKEYHMAC_INCLUDE
...
/**
 * \brief OpenPGP implementation for HMAC keys.
 *
 * Used to provide HMAC keys to OpenPGPCryptoHashHMAC
 */

class DSIG_EXPORT OpenPGPCryptoKeyHMAC : public XSECCryptoKeyHMAC {
...
#endif /* OPENPGPCRYPTOKEYHMAC_INCLUDE */
