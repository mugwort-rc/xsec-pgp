 ...
 *
 * $Id: OpenPGPCryptoHash.hpp 1125514 2011-05-20 19:08:33Z scantor $
 *
 */

#ifndef OPENPGPCRYPTOHASH_INCLUDE
#define OPENPGPCRYPTOHASH_INCLUDE
...
class DSIG_EXPORT OpenPGPCryptoHash : public XSECCryptoHash {
...
public :
	...
	OpenPGPCryptoHash(XSECCryptoHash::HashType alg);
	virtual ~OpenPGPCryptoHash();
	 ...
	 * then OpenPGPCryptoHashHMAC should be used.
	 *
...
#endif /* OPENPGPCRYPTOHASH_INCLUDE */
